...
const VisitPage: React.FC = () => {
    return (
        <div className="bg-cream min-h-screen w-full overflow-hidden pt-24 pb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                    ...
                    >
                        <div className="space-y-6">
                            <h2 className="font-serif text-4xl text-forest">Location</h2>
                            <div className="font-sans text-lg text-loam/80 leading-relaxed space-y-2">
                                ...
                                <a
                                    ...
                                    className="inline-block text-clay hover:text-gold transition-colors underline decoration-1 underline-offset-4 mt-2"
                                >
                                    Get Directions
                                </a>
                            </div>
                        ...
                        <div className="space-y-6">
                            <h2 className="font-serif text-4xl text-forest">Hours</h2>
                            <div className="font-sans text-lg text-loam/80 leading-relaxed space-y-2">
            ...
            <section className="py-24 bg-forest text-cream">
                <div className="max-w-7xl mx-auto px-6 text-center space-y-12">
                    ...
                    <motion.p
                        ...
                        transition={{ duration: 0.8, delay: 0.2 }}
                        viewport={{ once: true }}
                        className="font-sans text-xl max-w-3xl mx-auto text-cream/80 leading-relaxed"
                    >
